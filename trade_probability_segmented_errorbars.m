...
% Define range of trade probability levels and preallocate storage
trade_probs = 0:0.1:1;
num_levels = length(trade_probs);
...
% Plotting
figure;
errorbar(trade_probs, avg_total, std_total, '-o', 'LineWidth', 2);
xlabel('Trade Probability');
ylabel('Average Final Wealth');
title('Total Average Wealth vs Trade Probability');
grid on;

figure;
errorbar(trade_probs, avg_top10, std_top10, '-s', 'LineWidth', 2);
xlabel('Trade Probability');
ylabel('Top 10% Average Final Wealth');
title('Top 10% Wealth vs Trade Probability');
grid on;

figure;
errorbar(trade_probs, avg_bottom10, std_bottom10, '-^', 'LineWidth', 2);
xlabel('Trade Probability');
ylabel('Bottom 10% Average Final Wealth');
title('Bottom 10% Wealth vs Trade Probability');
grid on;
